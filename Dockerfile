...
RUN curl -o packer.zip https://releases.hashicorp.com/packer/1.7.0/packer_1.7.0_linux_amd64.zip && unzip packer.zip && rm packer.zip && mv packer /usr/local/bin/packer
WORKDIR /project
CMD /bin/bash
